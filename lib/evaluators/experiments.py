...
MDM_FOLDER = Path("/home/lxxiao/xlx/motion-diffusion-model/save/humanml_trans_enc_512")
MDM_SMPL_FOLDER = Path(
    "/home/lxxiao/xlx/stmc/pretrained_models/mdm-smpl_clip_smplrifke_humanml3d"
)
#MotionDiffuse_FOLDER = Path("/home/lxxiao/xlx/stmc/motion_diffuse")
...
experiments = mdm_experiments + mdm_smpl_experiments
